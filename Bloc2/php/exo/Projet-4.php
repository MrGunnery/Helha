...
<body align="center" style="font-size: 20px">
		...
		<table style="border-style: groove;" align="center">
		...
		<p>
			<?php echo("Il a fait le plus froid le: ".trouve($septembre, minimum($septembre))." avec une têmperature de ". minimum($septembre)) ?>
		</p>
		<p>
			<?php echo("Il a fait le plus chaud le: ".trouve($septembre, maximum($septembre))." avec une têmperature de ". maximum($septembre)) ?>
		</p>
		<p>
