...
</select><br/>Annee : <select name="year">
...
function showCalendar($periode,$time) {
		...
		$pas = 0;
		$indexe = 1;
		$leCalendrier .= "\n\t<h2>&raquo; " . monthNumToName(getMonth($periode)) . " " . getYear($periode) . '</h2><table width="400" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#330066" bgcolor="#FFFFFF">';
		$leCalendrier .= "
